...
public class MapMessage implements IAsdMessage {
	...
	public void logSummary() {
		log_.infof("MAP", "MAP message: intersection ID = %d, content version = %d, ref lat = %f, ref lon = %f",
	...
	private static Logger		log_ = (Logger)LoggerManager.getLogger(MapMessage.class);
