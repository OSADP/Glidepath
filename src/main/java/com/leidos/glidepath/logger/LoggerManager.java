...
import com.leidos.glidepath.appcommon.GlidepathVersion;
...
public class LoggerManager {
    ...
    /**
     * Create or retrieve an instance of an {@link com.leidos.glidepath.logger.ILogger} implementation for class origin.
    ...
    public synchronized static void writeToDisk() throws IOException {
        ...
        for (Logger logger : loggerInstances.values()) {
            toBeWritten = toBeWritten.merge(toBeWritten, logger.getBuffer());
        }
     ...
     * @param listener The {@link com.leidos.glidepath.logger.LogListener} object to be registered
     */
    ...
    /**
     * Only LogEntries more severe than min will be written to output file. Severity is defined in {@link com.leidos.glidepath.logger.LogEntry.Level}.
     ...
     * {@link com.leidos.glidepath.logger.LogBuffer} to filter {@link com.leidos.glidepath.logger.LogEntry}s based on
