...
import com.leidos.glidepath.ead.AccelerationManager;
...
public class XgvConnection {
    ...
    public XgvConnection(DatagramSocket sock, InetSocketAddress outbound) {
        ...
        retryLimit = GlidepathApplicationContext.getInstance().getAppConfig().getJausRetryLimit();
    ...
    public void sendQueryVelocityStateMessage() throws IOException {
        ...
        int velocityStateSensorId = GlidepathApplicationContext.getInstance().getAppConfig().getVssJausId();
    ...
    public void sendDiscreteDeviceStateQuery() throws IOException {
        ...
        int primitiveDriverId = GlidepathApplicationContext.getInstance().getAppConfig().getPdJausId();
