...
public class XgvConsumer implements IConsumerTask {
    ...
    public boolean initialize() {
        ...
        int judpPort = GlidepathApplicationContext.getInstance().getAppConfig().getJausUdpPort();
        String xgvIpAddress = GlidepathApplicationContext.getInstance().getAppConfig().getXgvIpAddress();
    ...
    public void releaseMpdControl()   {
        int mpd = GlidepathApplicationContext.getInstance().getAppConfig().getMpdJausId();
    ...
    public DataElementHolder call() throws Exception {
        ...
        int motionProfileId = GlidepathApplicationContext.getInstance().getAppConfig().getMpdJausId();
